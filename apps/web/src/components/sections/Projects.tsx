...
const projects: Project[] = [
  ...
  },
  {
    ...
    fullDescription: "Booky is a digital library application built with React and Firebase. It features user authentication, book management, reading lists, and personalized recommendations.",
    category: "web",
    technologies: ["React", "Firebase", "Authentication", "Tailwind CSS"],
    githubUrl: "https://github.com",
    liveUrl: "https://booky-app.vercel.app",
  ...
  },
  {
    ...
    slug: "flipkart-clone",
    shortDescription: "Responsive e-commerce website",
    fullDescription: "Flipkart Clone is a fully responsive e-commerce website built with modern web technologies. Features include product listings, cart functionality, and user authentication.",
    category: "web",
    technologies: ["HTML", "CSS", "JavaScript", "Bootstrap"],
    githubUrl: "https://github.com",
    liveUrl: "https://flipkart-clone.vercel.app",
    thumbnail: "/images/projects/flipkart-clone.jpg",
    featured: false,
